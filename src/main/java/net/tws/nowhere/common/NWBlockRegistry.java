...
public class NWBlockRegistry {

    //Registry
    public static final DeferredRegister.Blocks BLOCK_REGISTRIES = DeferredRegister.createBlocks(NWMain.MODID);
    ...
    //BlockItems
    public static final DeferredItem<BlockItem> PARCHED_LOG_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("parched_log", PARCHED_LOG);
    public static final DeferredItem<BlockItem> STRIPPED_PARCHED_LOG_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("stripped_parched_log", STRIPPED_PARCHED_LOG);
    public static final DeferredItem<BlockItem> PARCHED_PLANKS_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("parched_planks", PARCHED_PLANKS);
    public static final DeferredItem<BlockItem> PARCHED_DOOR_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("parched_door", PARCHED_DOOR);
    public static final DeferredItem<BlockItem> DUST_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("dust_block", DUST_BLOCK);
    public static final DeferredItem<BlockItem> DUSTY_BITUMEN_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("dusty_bitumen", DUSTY_BITUMEN);
    public static final DeferredItem<BlockItem> PACKED_DUST_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("packed_dust_block", PACKED_DUST_BLOCK);
    public static final DeferredItem<BlockItem> DUSTSTONE_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("duststone", DUSTSTONE);
    public static final DeferredItem<BlockItem> DUSTSTONE_BRICKS_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("duststone_bricks", DUSTSTONE_BRICKS);
    public static final DeferredItem<BlockItem> FERROUS_SCRAP_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("ferrous_scrap_block", FERROUS_SCRAP_BLOCK);
    public static final DeferredItem<BlockItem> FERROUS_ALLOY_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("ferrous_alloy_block", FERROUS_ALLOY_BLOCK);
    public static final DeferredItem<BlockItem> FERROUS_ALLOY_DOOR_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("ferrous_alloy_door", FERROUS_ALLOY_DOOR);
    public static final DeferredItem<BlockItem> SALT_CRUST_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("salt_crust", SALT_CRUST);
    public static final DeferredItem<BlockItem> BITUMEN_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.registerSimpleBlockItem("bitumen_block", BITUMEN_BLOCK);
    public static final DeferredItem<BlockItem> MAKESHIFT_TORCH_BLOCK_ITEM = NWItemRegistry.ITEM_REGISTRIES.register("makeshift_torch", (torch) -> new StandingAndWallBlockItem(MAKESHIFT_TORCH.get(), WALL_MAKESHIFT_TORCH.get(), new Item.Properties(), Direction.DOWN));
