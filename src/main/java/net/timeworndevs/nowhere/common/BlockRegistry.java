...
public class BlockRegistry {
    ...
    public static final DeferredBlock<Block> BITUMEN_BLOCK = BLOCK_REGISTRIES.register("bitumen_block", () -> new SoulSandBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).sound(SoundType.MUD_BRICKS).strength(0.5F,0.5F).speedFactor(0.4F)));
