...
public class BlockRegistry {
    ...
    public static final DeferredBlock<Block> MAKESHIFT_TORCH = BLOCK_REGISTRIES.register("makeshift_torch", () -> new TorchBlock(ParticleTypes.FLAME, BlockBehaviour.Properties.of().mapColor(MapColor.FIRE).sound(SoundType.STEM).instabreak().pushReaction(PushReaction.DESTROY).lightLevel((level) -> {return 12;})));
    public static final DeferredBlock<Block> WALL_MAKESHIFT_TORCH = BLOCK_REGISTRIES.register("makeshift_wall_torch", () -> new WallTorchBlock(ParticleTypes.FLAME, BlockBehaviour.Properties.of().mapColor(MapColor.FIRE).sound(SoundType.STEM).instabreak().pushReaction(PushReaction.DESTROY).lightLevel((level) -> {return 12;})));
