...
public class ItemRegistry {
    ...
    public static final DeferredItem<Item> SCRAP_SHOVEL = ITEM_REGISTRIES.registerSimpleItem("scrap_shovel", new Item.Properties().component(DataComponents.TOOL, NowhereTiers.SCRAP.createToolProperties(BlockTags.MINEABLE_WITH_SHOVEL)).component(DataComponents.MAX_STACK_SIZE, 1).component(DataComponents.MAX_DAMAGE, 131).component(DataComponents.DAMAGE, 0));
